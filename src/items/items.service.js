...
var update = function (id, updateItem) { return __awaiter(void 0, void 0, void 0, function () {
    var item;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.find)(id)];
            case 1:
                item = _a.sent();
                if (!item) {
                    return [2 /*return*/, null];
                }
                items[id] = __assign({ id: id }, updateItem);
                return [2 /*return*/, items[id]];
        }
    });
}); };
